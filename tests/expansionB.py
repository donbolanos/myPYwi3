#
'''
This script plot the expansion of the B shell depending on the time  
'''
#
import sys
import os
...
#
# .. load the run
path = '/media/sbolanos/BatDRIVE/HECKLE/400x400_ohs/ohs1/'#'/media/sbolanos/TOURO/HECKLE/270x540_ths/t_8-38/'
name = 'ohs1'
